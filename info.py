...
BOT_TOKEN = environ.get('BOT_TOKEN', "7462112646:AAHu0qbt4Xtu5iDFq4D1g_dC3Cg88yfzFBg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002160959777').split()] #Channel id for auto indexing ( make sure bot is admin )
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4286379252') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002151519538') # request channel id ( make sure bot is admin )
